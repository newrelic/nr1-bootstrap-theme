  ...
  render() {
    return (
      <div>
        ...
        <p>
          The <code>Dropdown</code> component is used to pass the <code>isOpen</code> &amp; <code>toggle</code> props
          via context to the following components: <code>DropdownToggle</code>, <code>DropdownMenu</code>.
          The <code>DropdownToggle</code> uses the <code>Button</code> component internally, meaning it also accepts all
          the props the <Link to="/components/buttons/">Button component</Link> accepts.
        </p>
...
DropdownItem.propTypes = {
  ...
  toggle: PropTypes.bool // default: true
        ...
        <p>To align the <code>DropdownMenu</code> to the right, add a <code>right</code> prop to <code>Dropdown</code>.
        </p>
        <div className="docs-example">
  ...
  <DropdownMenu>
    ...
        ...
        <p>
          ...
          manage/control the state of the component. <code>UncontrolledDropdown</code> does not
          require <code>isOpen</code> nor <code>toggle</code> props to work. For the <code>ButtonDropdown</code> flavor,
          an uncontrolled component have been made as well; <code>UncontrolledButtonDropdown</code>.
        </p>
        <div className="docs-example">
        ...
        <div className="docs-example">
          <Row>
            <Col>
              <Dropdown direction="up" isOpen={this.state.ddDropup} toggle={() => {
            ...
            <Col>
              <Dropdown direction="left" isOpen={this.state.ddDropleft} toggle={() => {
            ...
            <Col>
              <Dropdown direction="right" isOpen={this.state.ddDropright} toggle={() => {
...
{`<Dropdown isOpen={isOpen} toggle={toggle}>
  ...
  >
    ...
    <DropdownItem>Another Action</DropdownItem>
        ...
        <p>
          Use <code>setActiveFromChild</code> prop to automatically set the dropdown to active when any of the dropdown
          menu items are active. Note: this prop will not work in conjunction with
          react-router <code>Link</code> and <code>activeClassName</code>.
        </p>
        <div className="docs-example">
