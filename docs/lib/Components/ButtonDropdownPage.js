...
{`<ButtonDropdown isOpen={isOpen} toggle={toggle}>
  ...
  <DropdownMenu>
    ...
    <DropdownItem>Another Action</DropdownItem>
        ...
        <div className="docs-example">
          <div>
            <ButtonDropdown isOpen={this.state.btnLg} toggle={() => {
          ...
          <div className="mt-1">
            <ButtonDropdown isOpen={this.state.btnSm} toggle={() => {
  ...
  return (
    <UncontrolledButtonDropdown>
      ...
      <DropdownMenu>
        ...
        <div className="docs-example">
          <div>
            <ButtonDropdown direction="up" isOpen={this.state.btnDropup} toggle={() => {
            ...
            {' '}
            <ButtonDropdown direction="left" isOpen={this.state.btnDropleft} toggle={() => {
            ...
            {' '}
            <ButtonDropdown direction="right" isOpen={this.state.btnDropright} toggle={() => {
