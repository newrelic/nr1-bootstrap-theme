...
import { createMemoryHistory, hashHistory, match, Router, RouterContext } from 'react-router';
...
export default (locals, callback) => {
  ...
  match({routes, location}, (error, redirectLocation, renderProps) => {
    ...
    1: [function (e, n, t) {
        ...
        var u = (new Date).getTime(), f = e("handle"), c = e(3), s = e("ee"), p = e(2), d = window, l = d.document,
            m = "addEventListener", v = "attachEvent", g = d.XMLHttpRequest, w = g && g.prototype;
        NREUM.o = {
            ST: setTimeout,
            SI: d.setImmediate,
            CT: clearTimeout,
...
NREUM.info = {
    beacon: "bam.nr-data.net",
    errorBeacon: "bam.nr-data.net",
    licenseKey: "907243be46",
    applicationID: "345723962",
    sa: 1
}
      </script>
