...
import EmptyStatesPage from './Components/EmptyStatesPage';
import ErrorMessagesPage from './Components/ErrorMessagesPage';
import SidePanelsPage from './Components/SidePanelsPage';
import LinksExternalPage from './Components/LinksExternalPage';
import QueryExperiencePage from './Components/QueryExperiencePage';
...
const routes = (
  <Route path="/" component={UI.Layout}>
    ...
    <Route path="components/" component={Components}>
      ...
      <Route path="list-group/" component={ListGroupPage}/>
      <Route path="spinners/" component={SpinnersPage}/>
      <Route path="empty-states/" component={EmptyStatesPage}/>
      <Route path="error-messages/" component={ErrorMessagesPage}/>
      <Route path="side-panels/" component={SidePanelsPage}/>
      <Route path="query-experience/" component={QueryExperiencePage}/>
      <Route path="links-external/" component={LinksExternalPage}/>
    </Route>
